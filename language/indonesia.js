...
exports.UmurXReg = () =>{
	return`Umur kamu terlalu tua, bukannya mati ehh malah main bot:v candaaa`
	}
exports.firstChat = (a, b, c) =>{
	return`Selamat ${a} ${b} 👋, saya adalah ${c} yaitu bot whatsapp. Ada yang bisa ${c} bantu?
	untuk memulai bot ketik ( .menu ) tapi jangan lupa registrasi dulu dengan cara ketik ( #register ) terimakasihh😄
	`
	}
exports.StartAbsen = () =>{
	return`Mulai Absen`
...
exports.Hoja = () => {
    return `\n_Mencari sesuatu yang ga penting_`
}
exports.CovertWi = () => {
    return `\n_Mengonversi sesuatu dengan bot_`
}
exports.AnuFoto = () => {
...
saya ${botname}, bot ini adalah Beta Multi-Device Whatsapp. Bot masih dalam pengembangan jadi kalau kalian menemukan bug/error bisa langsung chat ownernya aja ya
`
}
...
Grup bot ? https://chat.whatsapp.com/HO3t8UUbuLUJvs6opeZu3s
`
}
exports.welcome = () =>{
	return`𝖩𝖺𝗇𝗀𝖺𝗇 𝗅𝗎𝗉𝖺 𝗂𝗇𝗍𝗋𝗈 𝗄𝖺𝗄 (ini agak alay sih:v)
...
exports.leave = () =>{
	return`Mental aman kan kak??:v
Goodbye`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*

Chat owner : wa.me/${ownernomer}
`
}
...
Hai kakk 👋
Kalian bisa mendukung saya agar bot ini tetap up to date dengan cara donasi melalui :

Dana : https://link.dana.id/qr/82s3i0ic (atau scan qr diatas)
Ovo : 085697871140
Pulsa : 085697871140

Berapapun donasi kalian akan sangat berarti, buat kalian yang sudah donasi bisa kirim bukti donasi ke owner agar bisa di masukkan ke list donasi
...
tenang ae ownernya friendly kok yang penting jangan di spam aja wkwkwk
